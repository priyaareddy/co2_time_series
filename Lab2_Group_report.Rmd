...
First we want to see when these models forecast that the atmospheric CO2 levels will reach 420ppm and 500ppm. Since we know there is a overall upwards trend as well as a seasonal component to the CO2 levels, when we generate these predictions we will actualy want to look at both the first and the last times that the model predicts the atmospheric CO2 levels to be at these values. 
